...
@Schema(description = "This event reports a consignment with a discrepancy.\nConforms to CIMP FSU status 'DIS'.")
public class Discrepancy extends FlightEvent {
    public Discrepancy(){}

    @JsonPropertyDescription("The flight the discrepancy is related to.")
    @Schema(description="The flight the discrepancy is related to.")
