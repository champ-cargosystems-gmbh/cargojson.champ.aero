...
public class Departed extends FlightEvent {
    ...
    public Optional<LocalDateTime> departureDate() {
        return Optional.ofNullable(timeOfEvent);
    }

    @Override
    public Optional<LocalDateTime> arrivalDate() {
        return timeOfScheduledArrival;
    }
