...
@JsonClassDescription("This event reports that the consignment was prepared for a specific flight.\nConforms to CIMP FSU status 'PRE'.")
@Schema(description = "This event reports that the consignment was prepared for a specific flight.\nConforms to CIMP FSU status 'PRE'.")
public class FreightPrepared extends FlightEvent {
    public FreightPrepared(){}

    @JsonPropertyDescription("The flight the consignment was prepared for.")
    @Schema(description="The flight the consignment was prepared for.")
    public Optional<FlightIdentity> flight = Optional.empty();

    @JsonPropertyDescription("The departure date of the flight the consignment was prepared for.")
    @Schema(description="The departure date of the flight the consignment was prepared for.")
