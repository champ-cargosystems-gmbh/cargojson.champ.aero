...
@Schema(description = "This event reports that the freight is on hand.\nConforms to CIMP FSU status 'FOH'.")
public class FreightOnHand extends FlightEvent {
    ...
    @Schema(description="The airport where the consignment was received.")
    ...
    @Schema(description = "The name of the individual or company the freight has been received from.", example = "K. Wilson, Supersonic Shipping Co.")
    public Optional<String> receivedFromName = Optional.empty();

    @JsonPropertyDescription("The volume of the freight.")
    @Schema(description="The volume of the freight.")
    public Optional<Volume> volume = Optional.empty();

    @JsonPropertyDescription("The density group of the freight.")
    @Schema(description="The density group of the freight.")
