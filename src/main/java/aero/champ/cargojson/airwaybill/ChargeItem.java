...
@Schema(description = "Charge item.")
public class ChargeItem {
    ...
    @Schema(description = "Rate combination point (RCP): Point over which sector rates are combined.\n" +
            "Pattern: uppercase three-letter code.", example = "PAR")
    ...
    @Schema(description = "Array of commodity item numbers. A commodity item number is to identify a specific commodity.", example = "9017")
    public Optional<Set<String>> commodityItemNumber = Optional.empty();

    @JsonPropertyDescription("Chargeable gross weight.")
    @Schema(description="Chargeable gross weight.")
    public Optional<Weight> grossWeight = Optional.empty();

    @JsonPropertyDescription("Nature and quantity of goods.")
    @Schema(description = "Nature and quantity of goods.", example = "Tooth paste")
    ...
    @Schema(description="Toggles whether 'goodsDescription' is contained in the house waybill.")
    ...
    @Schema(description="Country of origin of goods.")
