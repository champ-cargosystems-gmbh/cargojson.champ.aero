...
public class ULD {
    ...
    @Schema(description = "Code identifying a standard Unit Load Device type.\n" +
            "Must match regular expression '[A-Z][A-Z0-9]{2}'.", example = "ASE")
    public String type;
    ...
    @Schema(description = "Serial number allocated to each Unit Load Device by its owner.\n" +
            "Must match regular expression '[A-Z0-9][0-9]{3,4}'.", example = "1234")
    ...
    @Schema(description = "Code to identify the owner of a Unit Load Device.\n" +
            "Must match regular expression '[A-Z0-9]{2}'.", example = "TW")
    public String ownerCode;

    @JsonPropertyDescription("ULD loading indicator.")
    @Schema(description="ULD loading indicator.")
    ...
    @Schema(description = "Information related to a specific Unit Load Device", example = "Do not load via nose door.")
    public Optional<String> remarks = Optional.empty();

    @JsonPropertyDescription("Weight of the ULD contents.")
    @Schema(description="Weight of the ULD contents.")
