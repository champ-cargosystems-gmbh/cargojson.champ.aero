...
@Schema(description = "Enumeration of codes for special handling and dangerous goods.")
public enum SpecialHandlingAndDangerousGoodsCode {

    ACT("Active Temperature Controlled System"), AOG("Aircraft on Ground"),
    BUP("Bulk Unitization Programme, Shipper/Consignee Handled Unit"),
    CAO("Cargo Aircraft Only"), CAT("Cargo Attendant Accompanying Shipment"),
    ...
    COM("Company Mail"), ECP("Consignment established with a paper air waybill contract being printed under an e-AWB agreement"),
    ...
    DIP("Diplomatic Mail"), EAP("e-freight Consignment with Accompanying Paper Documents"),
    EAW("e-freight Consignment with No Accompanying Paper Documents"),
    EMD("Electronic Monitoring Devices on/in Cargo/Container"),
    REQ("Excepted Quantities of Dangerous Goods"),
    RRE("Excepted Quantities of Radioactive Material"), PES("Fish/Seafood"), PEF("Flowers"), EAT("Foodstuffs"),
    FRI("Frozen Goods Subject to Veterinary/Phytosanitary Inspections"), FRO("Frozen Goods"), PEP("Fruits and Vegetables"),
    ATT("Goods Attached to Air Waybill"), GOH("Hanging Garments"), HEG("Hatching Eggs"),
    HEA("Heavy Cargo/150 kilograms and over per piece"), HUM("Human Remains in Coffin"),
    PEA("Hunting trophies, skin, hide and all articles made from or containing parts of species listed in the CITES (Convention on International Trade in Endangered Species) appendices"), SCO("Cargo Secure forAll-Cargo Aircraft Only"), SPF("Laboratory Animals"), SPX("Cargo Secure for Passenger and All-Cargo Aircraft"), LIC("License Required"), AVI("Live Animal"), LHO("Living Human Organs/Blood"), MAL("Mail"), PEM("Meat"), MUW("Munitions of War"), NWP("Newspapers, Magazines"), OBX("Obnoxious Cargo"), BIG("Outsized"), OHG("Overhang Item"), PAC("Passenger and Cargo"), PER("Perishable Cargo"), PIL("Pharmaceuticals"), XPS("Priority Small Package"), QRT("Quick Ramp Transfer"), RAC("Reserved Air Cargo"), SHL("Save Human Life"), WET("Shipments of Wet Material not Packed in Watertight Containers"), SWP("Sporting Weapons"), SUR("Surface Transportation"), FIL("Undeveloped/Unexposed Film"), VAL("Valuable Cargo"), VIC("Very Important Cargo"), VOL("Volume"), VUN("Vulnerable Cargo"), PEB("Animal products for non-human consumption"), PHY("Goods subject to phytosanitary inspections"), VAG("SWISS Air Volume Agreement"),
    FSA("KLM FSA Code"), XPH("KLM XPH Code"), AER("KLM AER Code"), VIP("KLM VIP Code"),
    UCB("KLM UCB Code"), XPU("KLM XPU Code"), MON("KLM MON Code"), PEV("KLM PEV Code"),
    ART("KLM ART Code"), BSD("LH BSD Code"), BPL("LH BPL Code"), CSL("LH CSL Code"),
    DGR("LH DGR Code"), NOS("LH NOS Code"), PPL("LH PPL Code"), SEC("LH SEC Code"),
    SMU("LH SMU Code"), ZXF("LH ZXF Code"), ZXO("LH ZXO Code"),
    TRZ("LX TRZ Code "),
    GEN("DEN")
    ...
    ,CIC("Cargo may be loaded in the passenger cabin")
    ,ERT("Extended Room Temperature +2°C to +25°C")
    ,NST("Non Stackable Cargo")
